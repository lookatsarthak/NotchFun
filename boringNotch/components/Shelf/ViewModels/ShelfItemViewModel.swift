    ...
    private final class MenuActionTarget: NSObject {
        ...
        @MainActor @objc func handle(_ sender: NSMenuItem) {
            ...
            case "Compress":
                ...
                Task {
                    ...
                    // Nothing in here throws, so the do/catch that used to wrap it could never run.
        ...
        private func openWithPanel() {
            ...
            class PopupBinder: NSObject {
                ...
                // Target/action from an NSPopUpButton always arrives on the main
                // thread, so the AppKit objects touched below are safe to reach here.
